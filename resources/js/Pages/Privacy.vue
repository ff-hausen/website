    ...
    <MainLayout title="Datenschutzerklärung">
        <Box class="lg:max-w-[900px] lg:rounded-lg">
            ...
            <p>
                ...
                angezeigt, wo ein Nutzer mit der Plattform interagiert
                (z.&nbsp;B. in Foren oder Chats). Wenn ein Nutzer mit der
                Plattform interagiert, wird sein Avatar basierend auf der mit
                seiner E-Mail-Adresse verkn&uuml;pften Auswahl angezeigt. Dies
                verleiht der Online-Pr&auml;senz der Nutzer eine
                pers&ouml;nliche Note und erleichtert die Identifizierung, da
                das gew&auml;hlte Bild den Nutzern zugeordnet wird, wenn sie
                online aktiv sind.
            </p>
            <p>
            ...
            <p>
                ...
                Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt
                die Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6
                Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung
