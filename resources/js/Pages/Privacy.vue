    ...
    <MainLayout title="Datenschutzerklärung">
        <Box class="md:max-w-[65ch] md:rounded-lg">
            <article class="prose prose-sm max-w-none sm:prose-base">
                ...
                <p>
                    Telefon: 069 76752829<br />
                    E-Mail: info@ff-frankfurt-hausen.de
                </p>
                <p>
                ...
                <h3>Gravatar</h3>
                <p>
                    Wir haben Gravatar auf dieser Website eingebunden. Anbieter
                    ist die Automattic Inc., 60 29th Street #343, San Francisco,
                    CA 94110, USA (nachfolgend Gravatar).
                </p>
                <p>
                    Gravatar ist ein Tool, das es erm&ouml;glicht,
                    pers&ouml;nliche Bilder (Avatare) f&uuml;r die Nutzer
                    unserer Website bereitzustellen. Die Avatare dienen als
                    visuelle Repr&auml;sentationen der Nutzer und werden
                    &uuml;berall dort angezeigt, wo ein Nutzer mit der Plattform
                    interagiert (z.&nbsp;B. in Foren oder Chats). Wenn ein
                    Nutzer mit der Plattform interagiert, wird sein Avatar
                    basierend auf der mit seiner E-Mail-Adresse verkn&uuml;pften
                    Auswahl angezeigt. Dies verleiht der Online-Pr&auml;senz der
                    Nutzer eine pers&ouml;nliche Note und erleichtert die
                    Identifizierung, da das gew&auml;hlte Bild den Nutzern
                    zugeordnet wird, wenn sie online aktiv sind.
                </p>
                <p>
                    Wenn Sie auf unserer Website kommentieren bzw. interagieren
                    und dabei Gravatar aktiviert ist, wird der Hash der
                    E-Mail-Adresse des Nutzers, der Gravatar nutzt (wird als ID
                    genutzt) von Gravatar verarbeitet.
                </p>
                <p>
                    ...
                    seiner Foren. Sofern eine entsprechende Einwilligung
                    abgefragt wurde, erfolgt die Verarbeitung
                    ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a
                    DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist
                    jederzeit widerrufbar.
                </p>
                <p>
                    Weitere Details entnehmen Sie der Datenschutzerkl&auml;rung
                    des Anbieters unter
                    <a
                ...
                <p>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        >https://www.dataprivacyframework.gov/participant/4709</a
                    >.
                </p>
                <p class="text-right text-gray-400">
                    Quelle:
                    <a href="https://www.e-recht24.de" class="text-gray-400">
